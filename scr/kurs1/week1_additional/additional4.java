...
public class additional4 {
    public static void main(String[] args) {
        ...
        if (a > c) System.out.println("скорость в км/ч больше скорости скорость в м/c ");
        if (a < c) System.out.println("скорость в км/ч меньше скорости скорость в м/c ");
        else  if (a == c) System.out.println("скорости равны ");
